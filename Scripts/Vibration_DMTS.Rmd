...
In this document we tested if free-moving honey bees could be trained using appetite-aversive conditioning to use the presence/absence of a vibration cue or the duration of a vibration cue to solve a symbolic delayed matching-to-sample task. This document provides details on data processing, statistical analysis and figures of the original manuscript submitted for peer review.
...
scale_linetype_identity(guide = "legend", 
                        breaks = c("solid", "dashed", "dotted", "twodash"), 
